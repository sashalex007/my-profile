  ...
  return (
    <Card elevation={0}  sx={{ maxWidth: 'auto', mx: 'auto', height: '100%' }}>
      ...
      <CardContent>
        ...
        &emsp; Software engineer, studied physics at Carleton University. Experienced in web development (full-stack), android development, Java, and C++ for my hardware projects. I am a big believer in self-teaching, nothing is impossible! (for those who read documentation ;) )
<br></br><br></br>
...
I love solving problems that challenge my abilities. My areas of intrest are time & space complexity optimization and dynamic programming. 
